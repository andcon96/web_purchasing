...
@section('menu_name','Item RFQ Master')
@section('breadcrumbs')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Master</a></li>
  <li class="breadcrumb-item active">Item RFQ Master</li>
</ol>
@endsection
...
<div class="form-group row">
  <label for="part" class="col-md-0 col-form-label">{{ __(' Item No.') }}</label>
  <div class="col-md-3">
...
<div class="table-responsive col-lg-12 col-md-2 tag-container mt-3">
  ...
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <tbody>
      @include('setting.table-itmrfqmstr')
    </tbody>
...
<script type="text/javascript">
  function fetch_data(page, itempart, prodline, itemtype) {
    $.ajax({
      url: "/itmrfqmstrcari?page=" + page + "&part=" + itempart + "&prod=" + prodline + "&type=" + itemtype,
