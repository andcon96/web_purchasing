...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Request for Purchase Detail</li>
</ol>
@endsection
    	...
    	{{csrf_field()}}
			...
			<div class="modal-body">
			    ...
			    <div class="form-group row col-md-12">
					...
					<input type="hidden" class="form-control" name="duedate" id="duedate" value="{{$norfp->xrfp_duedate}}">
               ...
               <div class="form-group row" id="remarks">
                  <label for="e_remarks" class="col-md-2 col-form-label text-md-right">{{ __('Remarks') }}</label>
                  <div class="col-md-9">
                     <input id="e_remarks" type="text" class="form-control" name="e_remarks" value="" autofocus autocomplete="off">
                  </div>
               </div>
					<div class="form-group row" id="convertthis">
	...
	<script>
		$(document).ready(function(){
            ...
            if(session != approver && session != altapprover){
               ...
               document.getElementById('convertthis').style.display = 'none';
		...
		$(document).on('click', '.infopo', function(e){
			var item = $(this).data('itemcode');

			document.getElementById('l_item').value = item;
