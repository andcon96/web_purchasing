...
@section('menu_name','Shipment Browse')
@section('breadcrumbs')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Transaksi</a></li>
  <li class="breadcrumb-item active">Shipment Browse</li>
</ol>
@endsection
@section('content')
    ...
    <div class="form-group row" style="margin-bottom:0px !important;margin-left:1px;">       
      <!-- <form action="/sjmtcari" method="GET" style="display:flex"> -->
        <label for="id" class="col-md-2 col-form-label">{{ __('Shipper ID') }}</label>
        <div class="col-md-2">
            <input id="id" type="text" class="form-control" name="id" autocomplete="off" 
            value="" autofocus>
        </div> 

        <!-- <label for="id" class="col-md-1 col-form-label">{{ __('Status') }}</label>
        <div class="col-md-2">
            <input id="id" type="text" class="form-control" name="id" autocomplete="off" 
            value="" autofocus>
        </div>  -->
...
<script type="text/javascript">
    ...
    $.ajax({
      url: "/sjmtbrw/search?page=" + page + "&shippingid=" + shippingid,
