                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  @forelse($unpobysupp as $show)
                    <tr>
                      ...
                      <td data-title = 'Due Date'>{{ $show->xpod_due_date }} </td>
                      <td data-title = 'Days Until Due'>{{\Carbon\Carbon::parse($show->xpod_due_date)->diffInDays() }}</td>
                    </tr>
                  @empty
