...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Purchase Order Audit Trail</li>
</ol>
@endsection
...
<div class="form-group row">
      ...
      <div class="offset-md-2 offset-lg-0 ml-3">
        ...
        <button class="btn bt-action seconddata" id='btnrefresh' style="margin-left: 10px; width: 40px !important"><i class="fas fa-sync"></i></button>
      </div>
</div>

@include('po.tableauditpo')
